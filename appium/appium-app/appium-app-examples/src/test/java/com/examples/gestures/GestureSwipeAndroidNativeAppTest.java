...
public class GestureSwipeAndroidNativeAppTest {
  ...
  public void swipeUpOnElement() throws MalformedURLException {
    ...
    ((JavascriptExecutor) driver)
        .executeScript(
            "mobile: swipeGesture",
            ImmutableMap.of("elementId", elementId, "direction", "up", "percent", 1.00));
  ...
  public void swipeUpUsingW3CActions() throws MalformedURLException {
    ...
    // Good article:
    // https://www.linkedin.com/pulse/guide-perform-appium-20-w3c-mobile-actions-swipe-ꜱᴀɴᴋᴇᴛ-ᴊᴏꜱʜɪ
    ...
    tapPoint.addAction(
        finger.createPointerMove(
            Duration.ofMillis(0), PointerInput.Origin.viewport(), centerX, startY));
    ...
    tapPoint.addAction(
        finger.createPointerMove(
            Duration.ofMillis(500), PointerInput.Origin.viewport(), centerX, endY));
