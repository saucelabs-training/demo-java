...
public class CopyOfSampleSauceTest implements SauceOnDemandSessionIdProvider {
    ...
    public CopyOfSampleSauceTest(String os, String version, String browser, String deviceName, String deviceOrientation) {
        super();
        this.os = os;
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "Copy of Sauce Sample Test");
