...
public class RemoteWebDriverBuilderTest extends TestBase {
   ...
   * Connection and Read Timeouts 2. Automatically applies augmentation for casting to valid
   * interfaces 3. Keeps Browser Options and Sauce Options separate 4. Address values are Strings
   * not URL, which is just easier
   */
