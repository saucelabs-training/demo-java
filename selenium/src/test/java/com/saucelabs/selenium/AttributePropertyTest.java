...
public class AttributePropertyTest extends TestBase {
   ...
   *
   * <p>WebElement#getAttribute guesses which value you want from an element's attribute or property
   * value and returns that
   *
   * <p>Since this doesn't make sense in a specification, w3c defines 2 new endpoints, made
   * available in Selenium as: WebElement#getDomProperty and WebElement#getDomAttribute
   *
   * <p>The old behavior with the existing method is still available, but executes a large
